...
<div class="row">
  ...
  <input type="hidden" name="business" value="support-facilitator@expressbacklinkservice.com">
...
<!--  ***********CART TOTALS*************-->
<a class="btn btn-primary" target="shop.php" href="shop.php">Continue Shopping!</a>
